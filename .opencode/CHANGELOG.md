...
- Created 12 intelligence files in `.opencode/`

### Files Created
- `QUICK_START.md` — Fast onboarding for AI agents
- `SYSTEM_MAP.md` — High-level architecture overview
- `CODEBASE_MAP.md` — Detailed repository map with file responsibilities
